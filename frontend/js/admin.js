...
window.onload = () => {
    ...
    // ১. সিকিউরিটি চেক: সেশন স্টোরেজে সঠিক পাসওয়ার্ড আছে কি না
    ...
    if (auth !== ADMIN_PASS) {
        ...
        // যদি লগইন করা না থাকে তবে লগইন পেজে পাঠিয়ে দেবে

        window.location.href = 'admin-login.html'; 

    } else {

        // পাসওয়ার্ড সঠিক হলে সরাসরি ড্যাশবোর্ড ডাটা লোড করবে
