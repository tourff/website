...
// ১. ডাটাবেজ কানেকশন লজিক (সংশোধিত)
const dbURI = process.env.MONGODB_URI ? process.env.MONGODB_URI.trim() : "";

mongoose.connect(dbURI)
    .then(() => console.log('✅ Turjo Database Connected Successfully'))
    .catch(err => console.error('❌ DB Connection Error. Please check Railway Variables!'));
...
app.get('/products', async (req, res) => {
    try {
        ...
        res.status(200).json([]); // এরর হলেও খালি লিস্ট পাঠাবে
    }
});
