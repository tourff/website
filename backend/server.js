...
// ১. প্রোডাক্ট মডেল (নতুন ফিল্ডসমূহ যুক্ত করা হয়েছে)
...
const Product = mongoose.model('Product', new mongoose.Schema({
    ...
    soldCount: { type: Number, default: 0 },      // কতগুলো বিক্রি হয়েছে

    ratings: { type: Number, default: 5.0 },     // রেটিং

    reviews: { type: Number, default: 0 },       // কতজন রিভিউ দিয়েছে
...
app.post('/admin/add-product', async (req, res) => {
    ...
    // নতুন ফিল্ডগুলো বডি থেকে নেওয়া হচ্ছে
